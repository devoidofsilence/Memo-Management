...
namespace SBLApps.Migrations
{
    ...
    [Migration("20230817105834__AddedAccountFreezeAndAccountStatusFieldsInLinkEntities")]
    partial class _AddedAccountFreezeAndAccountStatusFieldsInLinkEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SBLApps.Models.BlacklistingMemoDetail", b =>
                {
                    ...
                    b.Property<string>("ChequeReturnDate")
                        .HasMaxLength(200)
            ...
            modelBuilder.Entity("SBLApps.Models.LinkedEntitiesDetail", b =>
                {
                    ...
                    b.ToTable("LinkedEntitiesDetails");
                });
            ...
            modelBuilder.Entity("SBLApps.Models.LinkedEntitiesDetail", b =>
                {
                    b.HasOne("SBLApps.Models.BlacklistingMemoMain", "BlacklistingMemoMain")
                        .WithMany("LinkedEntitiesDetails")
                        .HasForeignKey("MemoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SBLApps.Models.BlacklistingMemoMain", b =>
                {
                    ...
                    b.Navigation("LinkedEntitiesDetails");
